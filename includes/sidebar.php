<div class="col-md-3 col-lg-2 bg-dark text-white montserrat border-end  border-2 border-primary d-flex flex-column justify-content-between pb-4">
                <div class="nav flex-column nav-pills mt-0">
                    ...
                    <a class="nav-link text-white btn-sidebar mb-4" href="/projeto-pw/clientes/clientes.php">
                        <i class="bi bi-people-fill me-2"></i> Clientes
                    </a>

                    <a class="nav-link text-white btn-sidebar mb-4" href="/projeto-pw/barbeiros/barbeiros.php">
                        <i class="bi bi-scissors me-2"></i> Barbeiros
                    </a>

                    <a class="nav-link text-white btn-sidebar mb-4" href="/projeto-pw/servicos/servicos.php">
                ...
                <div class="px-2">
                    <a class="nav-link text-white btn-logout rounded px-3 py-2 w-100 d-flex align-items-center" href="/projeto-pw/auth/logout.php">
